...
public static class StringExtensions
{
    ...
    /// <summary>
    /// First letter of string is converted to Capital letter
    /// </summary>
    /// <param name="input"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Converts string input in cyrilic to latin 
    /// </summary>
    /// <param name="input">cyrilic input</param>
    ...
    /// <summary>
    /// Converts string input in latin to cyrilic
    /// </summary>
    /// <param name="input"></param>
    ...
    /// <summary>
    /// Returns first chars from string.Number of returned chars is equal to charsCount.
    /// </summary>
    /// <param name="input"></param>
