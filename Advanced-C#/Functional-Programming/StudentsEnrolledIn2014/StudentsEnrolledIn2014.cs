...
namespace StudentsEnrolledIn2014
{
    class StudentsEnrolledIn2014
    {
        static void Main()
        {
            ...
            var studentsenrolled2014 = listOfStudents
                ...
                (
                    student =>
                        new
                        {
                            ...
                            YearOfEntry = "20" + student.FacultyNumber.Substring(4, 2),
                            student.Marks
                        }
                );
            ...
            {
                Console.WriteLine("Name: {0} Year of entry: {1} Marks: {2}"
                    , student.FullName, student.YearOfEntry, string.Join(", ", student.Marks));
            }
        }
    }
}
